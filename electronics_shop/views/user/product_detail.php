        ...
        <div class="col-md-7">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?php echo $p['brand']; ?></li>
                </ol>
            </nav>
            ...
            <div class="card bg-light border-0 mb-4">
                <div class="card-body">
                    ...
                    <ul class="mb-0 small ps-3">
                        ...
                        <li>Giảm thêm 5% khi thanh toán qua QR Code.</li>
            ...
            <div class="d-flex gap-3 mb-4">
                <button class="btn btn-primary btn-lg flex-grow-1 fw-bold py-3">
                    MUA NGAY <br> <span class="small fw-normal">Giao hàng tận nơi hoặc nhận tại cửa hàng</span>
                </button>
                <button class="btn btn-outline-primary btn-lg p-3">
            ...
            <div class="row policy-box">
                ...
                <div class="col-6 policy-item"><i class="bi bi-truck"></i> Giao hàng tốc độ 2h</div>
                <div class="col-6 policy-item"><i class="bi bi-credit-card"></i> Trả góp 0% lãi suất</div>
            </div>
